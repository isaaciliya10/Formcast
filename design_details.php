    ...
    <div class="row">
      <div class="col-12">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item active"> <i class="fas fa-chevron-right"></i> <span> Stunning 4 bedroom home in village</span></li>
        </ol>
      </div>
    </div>
  </div>
...
<div class="wrapper">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0 order-lg-2">
          <div class="sticky-top">
            ...
            <div class="agent-contact">
              ...
              <div class="d-flex">
                <a href="#" class="btn btn-primary col ms-0 b-radius-none">Register</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-8 order-lg-1">
          <div class="property-detail-img popup-gallery">
            <div class="owl-carousel" data-animateOut="fadeOut" data-nav-arrow="true" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1" data-space="0" data-loop="true">
              <div class="item">
                <a class="portfolio-img" href="images/property/01.jpeg"><img class="img-fluid" src="images/property/01.jpeg" alt=""></a>
              </div>
              <div class="item">
                <a class="portfolio-img" href="images/property/02.jpeg"><img class="img-fluid" src="images/property/02.jpeg" alt=""></a>
              </div>
              <div class="item">
                <a class="portfolio-img" href="images/property/02.jpeg"><img class="img-fluid" src="images/property/03.jpeg" alt=""></a>
              </div>
              <div class="item">
                <a class="portfolio-img" href="images/property/06.jpeg"><img class="img-fluid" src="images/property/02.jpeg" alt=""></a>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <hr class="mb-5 mt-0">
    <h5 class="mb-4">Similar Designs</h5>
    <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        <div class="property-item">
          <div class="property-image bg-overlay-gradient-04">
            <img class="img-fluid" src="images/property/grid/04.jpeg" alt="">
            <div class="property-lable">
